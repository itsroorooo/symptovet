...
<div class="bg-white w-full h-full flex flex-col justify-center p-6">
    ...
    <div class="grid md:grid-cols-2 items-center gap-10 mt-12">
        ...
        <!-- Right Side (Form) - Moved to the left -->
        <form class="w-full max-w-md mx-auto order-2 md:order-1">
    ...
    <div class="mb-6">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="relative flex items-center">
                <input id="firstname" type="text" name="firstname" required
                    class="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-3 py-3 outline-none"
        ...
        <!-- Left Side (Image) - Moved to the right -->
        <div class="hidden md:block mt-20 order-1 md:order-2">
